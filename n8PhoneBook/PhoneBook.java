...
//    private List<Contact> contacts = new ArrayList<>();
    ...
    // since inputs are manageable
    int[] number = new int[10000000];
    String[] name = new String[10000000];
...
//                    break;
//                }
            if (number[query.number] != 0)  {
                wasFound = true;
                name[query.number] = query.name;
            }
...
//                }
            ...
            if (number[query.number] == 1)
                response = name[query.number];
